...
export default function StatusBar({ city, githubUser, availabilityText }: { city: string; githubUser: string; availabilityText: string; }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 h-10 bg-zinc-900/80 backdrop-blur border-t border-zinc-800 text-zinc-300 text-sm flex items-center justify-between px-3">
