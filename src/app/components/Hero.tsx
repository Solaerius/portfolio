        ...
        <div className="px-6 py-8 font-mono text-zinc-200">
          ...
          <div className="mt-2 flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-lg border border-zinc-800 px-3 py-2 hover:bg-zinc-800/80 transition"
            >
              GitHub
            </a>
            <a
              href="mailto:you@example.com"
              className="inline-flex items-center gap-2 rounded-lg border border-zinc-800 px-3 py-2 hover:bg-zinc-800/60 transition"
            >
              Email
            </a>
            <a
